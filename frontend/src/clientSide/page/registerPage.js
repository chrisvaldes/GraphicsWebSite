...
function RegisterPage(){
    ...
    function handleRegister(){
        axios.post("http://localhost:8083/RegisterPage", {userName, userEmail, userPassword, userType})
        .then(res =>{
            ...
            <div className="row" >
                <div className="col s12 m8 offset-m2">
                    <div className="card hoverable" style={{padding : "0 2rem"}}>
                        ...
                        <div className="form-group">
                            <label htmlFor="password" class="red"><i class="material-icons" style={{color : 'white'}}>lock</i></label>
